""" id_project3_portfolio.py

"""

# ------------------------------------------------------------------------------------------------------------------
# Part 6: read and utilize portfolio construction functions in
#         id_project3_portfolio.py to answer the questions in Part 7
# ------------------------------------------------------------------------------------------------------------------
...
def pf_input_sanity_check(df_cha, cha_name):
    ...
    df_cha : df
        ...
        See the docstring of the `merge_tables` function in id_project3_characteristics.py
...
def df_reshape(df_cha, cha_name):
    ...
    This function reshapes `df_cha`, the output table of `cha_main` function in id_project3_characteristics.py.
...
def pf_main(df_cha, cha_name, q):
    ...
    df_cha : df
        ...
        This df is the output of `cha_main` function in id_project3_characteristics.py.
        See the docstring there for a description of it.
    cha_name : str
