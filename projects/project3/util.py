...
def test_cfg():
    ...
    the project3 package was successfully imported as `cfg` and if the files
    are where they should be:

    toolkit/
    |
    |__ project3/
    |   |__ data/       <-- project3.config.DATADIR
    |
    """
    # Test if the data folder is inside the project3 folder
    # NOTE: The "parent" of the `data` folder is `project3`
    parent = os.path.dirname(cfg.DATADIR)
    to_print = f'''
The variable `parent` should point to the project3 folder:
  parent: '{parent}'
