...
# ----------------------------------------------------------------------------
# Part 2: import modules inside the project3 package
# ----------------------------------------------------------------------------
# Create import statements so that the module config.py and util.py (inside the project3 package)
...
import id_project3_characteristics as cha
import id_project3_portfolio as pf
...
def portfolio_main(tickers, start, end, cha_name, ret_freq_use, q):
    ...
    ret_freq_use  :  list
        ...
        in id_project3_characteristics.py.
...
#   config.py, id_project3_main.py, id_project3_etl.py, and id_project3_characteristics.py
#
...
# Notes:
# Please add the function in id_project3_main.py.
...
# ----------------------------------------------------------------------------
# Please refer to project3_desc.pdf for the instructions for Parts 10 and 11.
